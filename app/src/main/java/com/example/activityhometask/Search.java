...
public class Search extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toMap = findViewById(R.id.button_SearchToMap);
        toAccount = findViewById(R.id.button_SearchToAcc);
        toCatalog = findViewById(R.id.button_SearchToCat);
        Random rand = new Random();
        String first = String.valueOf(rand.nextInt(593));
        String second = String.valueOf(rand.nextInt(593));
        testModel = new TestModel(first, second);
        ...
        testModel = new TestModel(String.valueOf(rand.nextInt(593)),
                ...
                firstList,
                secondList);
        textView.setText("Search: " + testModel.getFirstString() + "  " + testModel.getSecondString());
